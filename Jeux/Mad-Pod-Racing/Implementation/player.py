...
class Player:
    def __init__(self, name, screen, checkpoints, player_send_q, player_receive_q):
        self.name = name
        self.screen = screen
    ...
    def update(self, dt):
        ...
        self.acc = .984 * self.acc + (pygame.Vector2(target_x, target_y) - self.pos).normalize() * thrust
    ...
    def inquire_user(self):
        ...
        if thrust == "BOOST":
            thrust = 200 if self.boost_available else 100
